...
declare module '$env/static/private' {
	...
	export const SPLM_LICENSE_SERVER: string;
	...
	export const UGII_BASE_DIR: string;
	export const UGII_LANG: string;
